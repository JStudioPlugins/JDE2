...
{
    //This was taken directly from the RM4 code. I definitely need this.
    public class DispatcherTool : MonoBehaviour
    {
        ...
        private static void RunAction(object action)
        {
            ...
            {
                UnturnedLog.exception(ex, "Error while running action");
            }
            finally
            {
